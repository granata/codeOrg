four51.app.directive('ordershippingguest', ['$rootScope', 'Order', 'Shipper', 'Address', 'AddressList', function($rootScope, Order, Shipper, Address, AddressList) {
    var obj = {
        restrict: 'AE',
        templateUrl: 'partials/controls/orderShippingGuest.html',
        controller: ['$scope', function($scope) {
            ...
            var saveChanges = function(callback, error) {
                ...
                //$scope.orderShipAddress.AddressName = $scope.orderShipAddress.Street1;
